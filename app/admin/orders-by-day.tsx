...
import { OrdersByDayChart } from '@/components/admin';
...
export default function AdminOrdersByDayScreen() {
  ...
  // All Orders by Day Query - pass -1 to get all days
  const ordersByDayQuery = useQuery({
    queryKey: ['admin-all-orders-by-day', dateRange.start.toISOString()],
    queryFn: () =>
      getAdminChartOrdersByDay(dateRange.start, dateRange.end, -1),
  });
  ...
  return (
    ...
    >
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            refreshing={ordersByDayQuery.isRefetching}
            onRefresh={onRefresh}
