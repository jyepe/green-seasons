...
import { RevenueByRestaurantChart } from '@/components/admin';
...
export default function AdminRestaurantsScreen() {
  ...
  // All Restaurants Query - pass -1 to get all restaurants
  const restaurantsQuery = useQuery({
    queryKey: ['admin-all-restaurants', dateRange.start.toISOString()],
    queryFn: () =>
      getAdminChartRevenueByRestaurant(dateRange.start, dateRange.end, -1),
  });
