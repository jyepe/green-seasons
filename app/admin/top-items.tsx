...
import { TopItemsCard } from '@/components/admin';
...
export default function AdminTopItemsScreen() {
  ...
  // All Top Items Query - pass -1 to get all items
  const topItemsQuery = useQuery({
    queryKey: ['admin-all-top-items', dateRange.start.toISOString()],
    queryFn: () => getAdminTopItems(dateRange.start, dateRange.end, -1),
  });
  ...
  return (
    ...
    >
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            refreshing={topItemsQuery.isRefetching}
            onRefresh={onRefresh}
